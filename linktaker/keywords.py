...
def build_search_url(keyword: str, date_filter: str = "", mode: str = "nws") -> str:
    """Build a Google search URL from a keyword and an optional date filter.

    mode: "nws" for Google News results, "web" for regular web search.
    """
    tbs_value, query_suffix = parse_date_filter(date_filter)
